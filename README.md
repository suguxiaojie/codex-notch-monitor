...
> [!IMPORTANT]
> 最新版本为 [`v1.6.1 (Build 15)`](https://github.com/suguxiaojie/codex-notch-monitor/releases/tag/v1.6.1)。Release 分别提供 Apple Silicon `arm64` 与 Intel `x86_64` 安装包，请按 Mac 处理器选择对应 DMG。
