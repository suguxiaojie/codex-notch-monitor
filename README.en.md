...
> [!IMPORTANT]
> The latest version is [`v1.6.1 (Build 15)`](https://github.com/suguxiaojie/codex-notch-monitor/releases/tag/v1.6.1). The Release provides separate DMGs for Apple Silicon `arm64` and Intel `x86_64`; choose the package that matches your Mac.
