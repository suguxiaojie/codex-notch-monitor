...
enum MonitorTheme {
    ...
    static let faintText = Color.white.opacity(0.30)
...
enum MonitorTypography {
    ...
    static let body = AstaSans.regular(9)
    static let metadata = AstaSans.regular(8)
    static let metadataMedium = AstaSans.medium(8)
